...
Use four-part numeric MSIX versions such as `0.1.1.0`. Create a matching Git tag such as `v0.1.1`. The release workflow converts a three-part tag to its four-part MSIX version.
