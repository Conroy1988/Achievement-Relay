...
2. Double-click it.
3. On a fresh install, the original CRNY track **Relay Online** starts locally at 10% volume. A verified update opens muted instead; select **Play music** if wanted. **Pause music**/**Play music** and **CRNY on SoundCloud** remain available at the lower-left.
