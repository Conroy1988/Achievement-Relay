...
Start with **Help & support**. **Sync Xbox now** tests OpenXBL → Achievement Relay → Discord. **Refresh Steam** restarts local game detection/observation. **Send Discord test** tests Discord only.
